...
exports.help = {
  ...
  extendedHelp: [
    ...
    "",
    "= Usage =",
    "Skyra, list                   :: I will show you all available public roles.",
    "Skyra, claim <role1, role2>   :: Claim one of more public roles.",
    "Skyra, unclaim <role1, role2> :: Unclaim one of more public roles.",
    "",
    "= Format =",
    ...
    "",
    "= Examples =",
    "Skyra, claim Designer, Programmer",
