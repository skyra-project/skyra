...
const pushRole = (channel, role, array) => channel.type !== 'category' ? channel.overwritePermissions(role, PERMISSIONS[channel.type]).catch(() => array.push(channel.toString())) : null;
