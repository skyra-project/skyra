...
const { CanvasConstructor } = require('../../../util');

CanvasConstructor.registerFont(resolve(join(__dirname, '..', '..', '..', '..', 'assets', 'fonts', 'koverwatch.ttf')), 'Overwatch');
...
const template = new CanvasConstructor(400, 420)
...
module.exports = async (profile, options) => {
	const canvas = new CanvasConstructor(400, 420)
