...
class CommandMessage {
    ...
    async validateArgs() {
        ...
        if (this._currentUsage.type === 'optional' && (typeof this.args[this.params.length] === 'undefined' || this.args[this.params.length] === '')) {
        ...
        } else if (this._currentUsage.type === 'required' && typeof this.args[this.params.length] === 'undefined') {
            this.args.splice(this.params.length, 1, null);
