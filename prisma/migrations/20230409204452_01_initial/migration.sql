...
CREATE TABLE "banner" (
    ...
    CONSTRAINT "PK_30e92cf52f8f78aeea005c46f44" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "client" (
    "id" VARCHAR(19) NOT NULL,
    "user_blocklist" VARCHAR[] DEFAULT ARRAY[]::VARCHAR[],
    "user_boost" VARCHAR[] DEFAULT ARRAY[]::VARCHAR[],
    "guild_blocklist" VARCHAR[] DEFAULT ARRAY[]::VARCHAR[],
    "guild_boost" VARCHAR[] DEFAULT ARRAY[]::VARCHAR[],

    CONSTRAINT "PK_1d7f977dce904d4ffd68ce226bb" PRIMARY KEY ("id")
);
...
CREATE TABLE "guilds" (
    ...
    "custom-commands" JSONB NOT NULL DEFAULT '[]',
...
CREATE TABLE "twitch_subscriptions" (
    ...
    "subscription_type" "twitch_subscriptions_subscription_type_enum" NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "IDX_690cc82abbfa67fc18db1c44e7" ON "twitch_subscriptions"("streamer_id", "subscription_type");
