		...
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					user_blocklist = table.Column<string[]>(type: "character varying[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					user_boost = table.Column<string[]>(type: "character varying[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					guild_blocklist = table.Column<string[]>(type: "character varying[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					guild_boost = table.Column<string[]>(type: "character varying[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]")
				},
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					disablenaturalprefix =
						table.Column<bool>(name: "disable-natural-prefix", type: "boolean", nullable: false),
					disabledcommands = table.Column<string[]>(name: "disabled-commands",
					...
					channelsfarewell = table.Column<string>(name: "channels.farewell", type: "character varying(19)",
						maxLength: 19, nullable: true),
					channelslogsmember = table.Column<string>(name: "channels.logs.member",
						type: "character varying(19)", maxLength: 19, nullable: true),
					channelslogsmessage = table.Column<string>(name: "channels.logs.message",
						type: "character varying(19)", maxLength: 19, nullable: true),
					channelslogsmoderation = table.Column<string>(name: "channels.logs.moderation",
						type: "character varying(19)", maxLength: 19, nullable: true),
					channelslogsnsfwmessage = table.Column<string>(name: "channels.logs.nsfw-message",
						type: "character varying(19)", maxLength: 19, nullable: true),
					channelslogsimage = table.Column<string>(name: "channels.logs.image", type: "character varying(19)",
						maxLength: 19, nullable: true),
					channelslogsprune = table.Column<string>(name: "channels.logs.prune", type: "character varying(19)",
						maxLength: 19, nullable: true),
					channelslogsreaction = table.Column<string>(name: "channels.logs.reaction",
						type: "character varying(19)", maxLength: 19, nullable: true),
					...
					channelsignorereactionadd = table.Column<string[]>(name: "channels.ignore.reaction-add",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					channelslogsrolecreate = table.Column<string[]>(name: "channels.logs.role-create",
						type: "character varying(19)", maxLength: 19, nullable: false),
					channelslogsroleupdate = table.Column<string[]>(name: "channels.logs.role-update",
						type: "character varying(19)", maxLength: 19, nullable: false),
					channelslogsroledelete = table.Column<string[]>(name: "channels.logs.role-delete",
						type: "character varying(19)", maxLength: 19, nullable: false),
					channelslogschannelcreate = table.Column<string[]>(name: "channels.logs.channel-create",
						type: "character varying(19)", maxLength: 19, nullable: false),
					channelslogschannelupdate = table.Column<string[]>(name: "channels.logs.channel-update",
						type: "character varying(19)", maxLength: 19, nullable: false),
					channelslogschanneldelete = table.Column<string[]>(name: "channels.logs.channel-delete",
						type: "character varying(19)", maxLength: 19, nullable: false),
					channelslogsemojicreate = table.Column<string[]>(name: "channels.logs.emoji-create",
						type: "character varying(19)", maxLength: 19, nullable: false),
					channelslogsemojiupdate = table.Column<string[]>(name: "channels.logs.emoji-update",
						type: "character varying(19)", maxLength: 19, nullable: false),
					channelslogsemojidelete = table.Column<string[]>(name: "channels.logs.emoji-delete",
						type: "character varying(19)", maxLength: 19, nullable: false),
					channelslogsserverupdate = table.Column<string[]>(name: "channels.logs.server-update",
						type: "character varying(19)", maxLength: 19, nullable: false),
					commandautodelete = table.Column<string>(name: "command-auto-delete", type: "jsonb",
						nullable: false, defaultValueSql: "'[]'::jsonb"),
					disabledchannels = table.Column<string[]>(name: "disabled-channels",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					disabledcommandschannels = table.Column<string>(name: "disabled-commands-channels", type: "jsonb",
						nullable: false, defaultValueSql: "'[]'::jsonb"),
					...
					eventsmemberadd = table.Column<bool>(name: "events.member-add", type: "boolean", nullable: false),
					eventsmemberremove =
						table.Column<bool>(name: "events.member-remove", type: "boolean", nullable: false),
					eventsmembernicknameupdate = table.Column<bool>(name: "events.member-nickname-update",
						type: "boolean", nullable: false),
					eventsmemberroleupdate = table.Column<bool>(name: "events.member-role-update", type: "boolean",
						nullable: false),
					eventsmessagedelete =
						table.Column<bool>(name: "events.message-delete", type: "boolean", nullable: false),
					eventsmessageedit =
						table.Column<bool>(name: "events.message-edit", type: "boolean", nullable: false),
					...
					messagesignoredchannels = table.Column<string[]>(name: "messages.ignored-channels",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					...
					messagesautodeleteignoredchannels = table.Column<string[]>(name: "messages.auto-delete.ignored-channels", type: "character varying(19)[]",
						nullable: false, defaultValueSql: "ARRAY[]::character varying[]"),
					messagesautodeleteignoredcommands = table.Column<string[]>(name: "messages.auto-delete.ignored-commands", type: "character varying(19)[]",
						nullable: false, defaultValueSql: "ARRAY[]::character varying[]"),
					...
					rolespublic = table.Column<string[]>(name: "roles.public", type: "character varying(19)[]",
						nullable: false, defaultValueSql: "ARRAY[]::character varying[]"),
					rolesremoveinitial =
						table.Column<bool>(name: "roles.remove-initial", type: "boolean", nullable: false),
					...
					rolessubscriber = table.Column<string>(name: "roles.subscriber", type: "character varying(19)",
						maxLength: 19, nullable: true),
					rolesuniquerolesets = table.Column<string>(name: "roles.unique-role-sets", type: "jsonb",
						nullable: false, defaultValueSql: "'[]'::jsonb"),
					selfmodattachmentsenabled = table.Column<bool>(name: "selfmod.attachments.enabled", type: "boolean",
						nullable: false),
					selfmodattachmentsignoredroles = table.Column<string[]>(name: "selfmod.attachments.ignored-roles",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					selfmodattachmentsignoredchannels = table.Column<string[]>(
						name: "selfmod.attachments.ignored-channels", type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					selfmodattachmentssoftaction = table.Column<short>(name: "selfmod.attachments.soft-action",
						type: "smallint", nullable: false),
					selfmodattachmentshardaction = table.Column<short>(name: "selfmod.attachments.hard-action",
						type: "smallint", nullable: false),
					selfmodattachmentshardactionduration =
						table.Column<int>(name: "selfmod.attachments.hard-action-duration", type: "integer",
							nullable: true),
					selfmodattachmentsthresholdmaximum = table.Column<short>(
						name: "selfmod.attachments.threshold-maximum", type: "smallint", nullable: false,
						defaultValueSql: "10"),
					selfmodattachmentsthresholdduration = table.Column<int>(
						name: "selfmod.attachments.threshold-duration", type: "integer", nullable: false,
						defaultValueSql: "60000"),
					selfmodcapitalsenabled =
						table.Column<bool>(name: "selfmod.capitals.enabled", type: "boolean", nullable: false),
					selfmodcapitalsignoredroles = table.Column<string[]>(name: "selfmod.capitals.ignored-roles",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					selfmodcapitalsignoredchannels = table.Column<string[]>(name: "selfmod.capitals.ignored-channels",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					...
					selfmodcapitalssoftaction = table.Column<short>(name: "selfmod.capitals.soft-action",
						type: "smallint", nullable: false),
					selfmodcapitalshardaction = table.Column<short>(name: "selfmod.capitals.hard-action",
						type: "smallint", nullable: false),
					selfmodcapitalshardactionduration = table.Column<int>(name: "selfmod.capitals.hard-action-duration",
						type: "integer", nullable: true),
					selfmodcapitalsthresholdmaximum = table.Column<short>(name: "selfmod.capitals.threshold-maximum",
						type: "smallint", nullable: false, defaultValueSql: "10"),
					selfmodcapitalsthresholdduration = table.Column<int>(name: "selfmod.capitals.threshold-duration",
					...
					selfmodlinksallowed = table.Column<string[]>(name: "selfmod.links.allowed",
						type: "character varying(128)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					selfmodlinksignoredroles = table.Column<string[]>(name: "selfmod.links.ignored-roles",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					selfmodlinksignoredchannels = table.Column<string[]>(name: "selfmod.links.ignored-channels",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					selfmodlinkssoftaction = table.Column<short>(name: "selfmod.links.soft-action", type: "smallint",
						nullable: false),
					selfmodlinkshardaction = table.Column<short>(name: "selfmod.links.hard-action", type: "smallint",
						nullable: false),
					selfmodlinkshardactionduration = table.Column<int>(name: "selfmod.links.hard-action-duration",
						type: "integer", nullable: true),
					selfmodlinksthresholdmaximum = table.Column<short>(name: "selfmod.links.threshold-maximum",
						type: "smallint", nullable: false, defaultValueSql: "10"),
					selfmodlinksthresholdduration = table.Column<int>(name: "selfmod.links.threshold-duration",
						type: "integer", nullable: false, defaultValueSql: "60000"),
					selfmodmessagesenabled =
						table.Column<bool>(name: "selfmod.messages.enabled", type: "boolean", nullable: false),
					selfmodmessagesignoredroles = table.Column<string[]>(name: "selfmod.messages.ignored-roles",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					selfmodmessagesignoredchannels = table.Column<string[]>(name: "selfmod.messages.ignored-channels",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					...
					selfmodmessagessoftaction = table.Column<short>(name: "selfmod.messages.soft-action",
						type: "smallint", nullable: false),
					selfmodmessageshardaction = table.Column<short>(name: "selfmod.messages.hard-action",
						type: "smallint", nullable: false),
					selfmodmessageshardactionduration = table.Column<int>(name: "selfmod.messages.hard-action-duration",
						type: "integer", nullable: true),
					selfmodmessagesthresholdmaximum = table.Column<short>(name: "selfmod.messages.threshold-maximum",
						type: "smallint", nullable: false, defaultValueSql: "10"),
					selfmodmessagesthresholdduration = table.Column<int>(name: "selfmod.messages.threshold-duration",
						type: "integer", nullable: false, defaultValueSql: "60000"),
					selfmodnewlinesenabled =
						table.Column<bool>(name: "selfmod.newlines.enabled", type: "boolean", nullable: false),
					selfmodnewlinesignoredroles = table.Column<string[]>(name: "selfmod.newlines.ignored-roles",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					selfmodnewlinesignoredchannels = table.Column<string[]>(name: "selfmod.newlines.ignored-channels",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					selfmodnewlinesmaximum = table.Column<short>(name: "selfmod.newlines.maximum", type: "smallint",
						nullable: false, defaultValueSql: "20"),
					selfmodnewlinessoftaction = table.Column<short>(name: "selfmod.newlines.soft-action",
						type: "smallint", nullable: false),
					selfmodnewlineshardaction = table.Column<short>(name: "selfmod.newlines.hard-action",
						type: "smallint", nullable: false),
					selfmodnewlineshardactionduration = table.Column<int>(name: "selfmod.newlines.hard-action-duration",
						type: "integer", nullable: true),
					selfmodnewlinesthresholdmaximum = table.Column<short>(name: "selfmod.newlines.threshold-maximum",
						type: "smallint", nullable: false, defaultValueSql: "10"),
					selfmodnewlinesthresholdduration = table.Column<int>(name: "selfmod.newlines.threshold-duration",
						type: "integer", nullable: false, defaultValueSql: "60000"),
					selfmodinvitesenabled =
						table.Column<bool>(name: "selfmod.invites.enabled", type: "boolean", nullable: false),
					selfmodinvitesignoredcodes = table.Column<string[]>(name: "selfmod.invites.ignored-codes",
						type: "character varying[]", nullable: false, defaultValueSql: "ARRAY[]::character varying[]"),
					selfmodinvitesignoredguilds = table.Column<string[]>(name: "selfmod.invites.ignored-guilds",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					selfmodinvitesignoredroles = table.Column<string[]>(name: "selfmod.invites.ignored-roles",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					selfmodinvitesignoredchannels = table.Column<string[]>(name: "selfmod.invites.ignored-channels",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					selfmodinvitessoftaction = table.Column<short>(name: "selfmod.invites.soft-action",
						type: "smallint", nullable: false),
					selfmodinviteshardaction = table.Column<short>(name: "selfmod.invites.hard-action",
						type: "smallint", nullable: false),
					selfmodinviteshardactionduration = table.Column<int>(name: "selfmod.invites.hard-action-duration",
						type: "integer", nullable: true),
					selfmodinvitesthresholdmaximum = table.Column<short>(name: "selfmod.invites.threshold-maximum",
						type: "smallint", nullable: false, defaultValueSql: "10"),
					selfmodinvitesthresholdduration = table.Column<int>(name: "selfmod.invites.threshold-duration",
						type: "integer", nullable: false, defaultValueSql: "60000"),
					...
					selfmodfilterraw = table.Column<string[]>(name: "selfmod.filter.raw",
						type: "character varying(32)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					selfmodfilterignoredroles = table.Column<string[]>(name: "selfmod.filter.ignored-roles",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					selfmodfilterignoredchannels = table.Column<string[]>(name: "selfmod.filter.ignored-channels",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					selfmodfiltersoftaction = table.Column<short>(name: "selfmod.filter.soft-action", type: "smallint",
						nullable: false),
					selfmodfilterhardaction = table.Column<short>(name: "selfmod.filter.hard-action", type: "smallint",
						nullable: false),
					selfmodfilterhardactionduration = table.Column<int>(name: "selfmod.filter.hard-action-duration",
						type: "integer", nullable: true),
					selfmodfilterthresholdmaximum = table.Column<short>(name: "selfmod.filter.threshold-maximum",
						type: "smallint", nullable: false, defaultValueSql: "10"),
					selfmodfilterthresholdduration = table.Column<int>(name: "selfmod.filter.threshold-duration",
						type: "integer", nullable: false, defaultValueSql: "60000"),
					selfmodreactionsenabled = table.Column<bool>(name: "selfmod.reactions.enabled", type: "boolean",
						nullable: false),
					selfmodreactionsignoredroles = table.Column<string[]>(name: "selfmod.reactions.ignored-roles",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					selfmodreactionsignoredchannels = table.Column<string[]>(name: "selfmod.reactions.ignored-channels",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					selfmodreactionsmaximum = table.Column<short>(name: "selfmod.reactions.maximum", type: "smallint",
						nullable: false, defaultValueSql: "10"),
					selfmodreactionsallowed = table.Column<string[]>(name: "selfmod.reactions.allowed",
						type: "character varying(128)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					selfmodreactionsblocked = table.Column<string[]>(name: "selfmod.reactions.blocked",
						type: "character varying(128)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					selfmodreactionssoftaction = table.Column<short>(name: "selfmod.reactions.soft-action",
						type: "smallint", nullable: false),
					selfmodreactionshardaction = table.Column<short>(name: "selfmod.reactions.hard-action",
						type: "smallint", nullable: false),
					selfmodreactionshardactionduration =
						table.Column<int>(name: "selfmod.reactions.hard-action-duration", type: "integer",
							nullable: true),
					selfmodreactionsthresholdmaximum = table.Column<short>(name: "selfmod.reactions.threshold-maximum",
						type: "smallint", nullable: false, defaultValueSql: "10"),
					selfmodreactionsthresholdduration = table.Column<int>(name: "selfmod.reactions.threshold-duration",
						type: "integer", nullable: false, defaultValueSql: "60000"),
					selfmodignoredchannels = table.Column<string[]>(name: "selfmod.ignored-channels",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					...
					nomentionspammentionsallowed = table.Column<short>(name: "no-mention-spam.mentions-allowed",
						type: "smallint", nullable: false, defaultValueSql: "20"),
					nomentionspamtimeperiod = table.Column<int>(name: "no-mention-spam.time-period", type: "integer",
					...
					socialachievemessage = table.Column<string>(name: "social.achieve-message",
					...
					socialignoredchannels = table.Column<string[]>(name: "social.ignored-channels",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					socialignoredroles = table.Column<string[]>(name: "social.ignored-roles",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					...
					starboardignoredchannels = table.Column<string[]>(name: "starboard.ignored-channels",
						type: "character varying(19)[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					moderator_id = table.Column<string>(type: "character varying(19)", maxLength: 19, nullable: false,
						defaultValueSql: "'365184854914236416'::character varying"),
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					attack_multiplier =
						table.Column<double>(type: "double precision", nullable: false, defaultValueSql: "1"),
					defense_multiplier =
						table.Column<double>(type: "double precision", nullable: false, defaultValueSql: "1"),
					agility_multiplier =
						table.Column<double>(type: "double precision", nullable: false, defaultValueSql: "1"),
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					channel_id = table.Column<string>(type: "character varying(19)", maxLength: 19, nullable: false),
					star_message_id =
						table.Column<string>(type: "character varying(19)", maxLength: 19, nullable: true),
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					reputations = table.Column<int>(type: "integer", nullable: false),
			...
			migrationBuilder.CreateTable(
				...
				{
					user_id = table.Column<string>(type: "character varying(19)", maxLength: 19, nullable: false),
					banners = table.Column<string[]>(type: "character varying[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					public_badges = table.Column<string[]>(type: "character varying[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					badges = table.Column<string[]>(type: "character varying[]", nullable: false,
						defaultValueSql: "ARRAY[]::character varying[]"),
					color = table.Column<int>(type: "integer", nullable: false),
					vault = table.Column<long>(type: "bigint", nullable: false),
					banner_level = table.Column<string>(type: "character varying(6)", maxLength: 6, nullable: false,
						defaultValueSql: "'1001'::character varying"),
					banner_profile = table.Column<string>(type: "character varying(6)", maxLength: 6, nullable: false,
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					challenged_user =
						table.Column<string>(type: "character varying(19)", maxLength: 19, nullable: false),
