...
namespace Skyra.Database.Models.Generated
{
	...
	public class RpgUser
	{
		...
		[Column("death_count")] public long DeathCount { get; set; }

		[Column("crate_common_count")] public int CrateCommonCount { get; set; }

		[Column("crate_uncommon_count")] public int CrateUncommonCount { get; set; }

		[Column("crate_rare_count")] public int CrateRareCount { get; set; }

		[Column("crate_legendary_count")] public int CrateLegendaryCount { get; set; }

		[Column("attack")] public int Attack { get; set; }

		[Column("health")] public int Health { get; set; }

		[Column("agility")] public int Agility { get; set; }
		...
		[Column("equipped_item_id")] public long? EquippedItemId { get; set; }

		[Column("guild_id")] public int? GuildId { get; set; }

		[Column("guild_rank_id")] public int? GuildRankId { get; set; }
