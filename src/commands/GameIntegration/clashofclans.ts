...
export class UserPaginatedMessageCommand extends PaginatedMessageCommand {
	...
	public static playerTagResolver: IArgument<string> = Args.make((parameter, { argument }) => {
		if (kPlayerTagRegex.test(parameter)) return ok(parameter);
		return err(Args.error({ argument, parameter, identifier: LanguageKeys.Commands.GameIntegration.ClashOfClansInvalidPlayerTag }));
	});
}
