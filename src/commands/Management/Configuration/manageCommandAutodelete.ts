...
@CreateResolvers([
	[
		...
		async (arg, _, message, [type]) => {
			...
			throw message.fetchLocale(LanguageKeys.Commands.Management.ManageCommandAutoDeleteTextChannel);
		}
	],
...
export default class extends SkyraCommand {
	...
	public async remove(message: KlasaMessage, [channel]: [TextChannel]) {
		...
		throw message.fetchLocale(LanguageKeys.Commands.Management.ManageCommandAutoDeleteRemoveNotset, { channel: channel.toString() });
	}
