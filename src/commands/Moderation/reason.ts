import { Command, constants : { MODERATION: { SCHEMA_KEYS } }, util; : { parseRange; } } from; '../../index';
...
export default class extends Command {
	...
	public async run(msg, [cases, reason]) {
	...
	public async _updateReason(channel, messages, modlog, reason) {
