...
import BWD_FOLDER from 'path'; ).join(rootFolder, 'bwd', 'cs';
import S_LOCATION from 'path'; ).join(BWD_FOLDER, 'eval.cs';
import E_LOCATION from 'path'; ).join(BWD_FOLDER, 'eval.exe';
