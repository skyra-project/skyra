				...
				embed
					...
					.addField(
						...
						[
							...
							`${fieldsData.overview.population}: ${country.population.toLocaleString(t.name)}`
						].join('\n')
					)
					...
					.addField(
						...
						[
							...
							country.area ? `${fieldsData.other.area}: ${country.area.toLocaleString(t.name)} km${SuperScriptTwo}` : null,
