...
export const GuildPrivateThreadChannelError = T('arguments:guildPrivateThreadChannelError');
export const GuildPublicThreadChannelError = T('arguments:guildPublicThreadChannelError');
export const GuildStageVoiceChannelError = T('arguments:guildStageVoiceChannelError');
