...
export const SocialResetAllPrompt = T('commands/social:socialResetAllPrompt');
export const SocialResetAllTimeOut = T('commands/social:socialResetAllTimeOut');
export const SocialResetAllAborted = T('commands/social:socialResetAllAborted');
export const SocialResetAllEmpty = T('commands/social:socialResetAllEmpty');
export const SocialResetAllSuccess = FT<{ count: number }>('commands/social:socialResetAllSuccess');
