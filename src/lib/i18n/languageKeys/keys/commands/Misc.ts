...
export const SetBirthdayNotConfigured = T<string>('commands/misc:setBirthdayNotConfigured');
...
export const ViewBirthdayNotSet = FT<{ birthDate: number; user: string }, string>('commands/misc:viewBirthdayNotSet');
