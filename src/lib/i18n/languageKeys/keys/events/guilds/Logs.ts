...
export const ChannelCreateParent = FT<Value>('events/guild-logs:channelCreateParent');
export const ChannelCreatePosition = FT<Value<number>>('events/guild-logs:channelCreatePosition');
export const ChannelCreateNsfw = T('events/guild-logs:channelCreateNsfw');
export const ChannelCreateTopic = FT<Value>('events/guild-logs:channelCreateTopic');
...
export const ChannelDelete = T('events/guild-logs:channelDelete');
...
export const ChannelUpdateName = FT<Difference>('events/guild-logs:channelUpdateName');
export const ChannelUpdateNsfw = FT<Difference>('events/guild-logs:channelUpdateNsfw');
export const ChannelUpdateParent = FT<Difference>('events/guild-logs:channelUpdateParent');
export const ChannelUpdateParentAdded = FT<Value>('events/guild-logs:channelUpdateParentAdded');
export const ChannelUpdateParentRemoved = FT<Value>('events/guild-logs:channelUpdateParentRemoved');
...
export const ChannelUpdateRateLimitAdded = FT<Value<number>>('events/guild-logs:channelUpdateRateLimitAdded');
export const ChannelUpdateRateLimitRemoved = FT<Value<number>>('events/guild-logs:channelUpdateRateLimitRemoved');
export const ChannelUpdateTopic = FT<Difference>('events/guild-logs:channelUpdateTopic');
export const ChannelUpdateTopicAdded = FT<Value>('events/guild-logs:channelUpdateTopicAdded');
export const ChannelUpdateTopicRemoved = FT<Value>('events/guild-logs:channelUpdateTopicRemoved');
export const ChannelUpdateType = FT<Difference>('events/guild-logs:channelUpdateType');
export const ChannelUpdateUserLimit = FT<Difference<number>>('events/guild-logs:channelUpdateUserLimit');
export const ChannelUpdateUserLimitAdded = FT<Value<number>>('events/guild-logs:channelUpdateUserLimitAdded');
export const ChannelUpdateUserLimitRemoved = FT<Value<number>>('events/guild-logs:channelUpdateUserLimitRemoved');
export const EmojiCreate = T('events/guild-logs:emojiCreate');
export const EmojiCreateAnimated = T('events/guild-logs:emojiCreateAnimated');
export const EmojiCreateUnAvailable = T('events/guild-logs:emojiCreateUnAvailable');
export const EmojiCreateManaged = T('events/guild-logs:emojiCreateManaged');
export const EmojiCreateRequiresColons = T('events/guild-logs:emojiCreateRequiresColons');
export const EmojiCreateRoles = FT<Values>('events/guild-logs:emojiCreateRoles');
export const EmojiDelete = T('events/guild-logs:emojiDelete');
export const EmojiUpdate = T('events/guild-logs:emojiUpdate');
export const EmojiUpdateAnimated = FT<Difference>('events/guild-logs:emojiUpdateAnimated');
export const EmojiUpdateAvailable = FT<Difference>('events/guild-logs:emojiUpdateAvailable');
export const EmojiUpdateManaged = FT<Difference>('events/guild-logs:emojiUpdateManaged');
export const EmojiUpdateName = FT<Difference>('events/guild-logs:emojiUpdateName');
export const EmojiUpdateRequiresColons = FT<Difference>('events/guild-logs:emojiUpdateRequiresColons');
export const EmojiUpdateRolesAdded = FT<Values>('events/guild-logs:emojiUpdateRolesAdded');
export const EmojiUpdateRolesRemoved = FT<Values>('events/guild-logs:emojiUpdateRolesRemoved');
export const RoleCreate = T('events/guild-logs:roleCreate');
export const RoleCreateColor = FT<Value>('events/guild-logs:roleCreateColor');
...
export const RoleDelete = T('events/guild-logs:roleDelete');
...
export const ServerUpdateMaximumPresencesAdded = FT<Value>('events/guilds-logs:serverUpdateMaximumPresencesAdded');
export const ServerUpdateMaximumPresencesRemoved = FT<Value>('events/guilds-logs:serverUpdateMaximumPresencesRemoved');
export const ServerUpdateMaximumPresences = FT<Difference>('events/guilds-logs:serverUpdateMaximumPresences');
