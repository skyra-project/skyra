...
export class V20UpdateGuildEntityChecks1597088981807 implements MigrationInterface {
	...
	private async createNewCheckContraints(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.createCheckConstraints('guilds', [
			...
			new TableCheck({
				name: this.generateCheckName(/* sql */`("selfmod.capitals.thresholdDuration" >= 0) AND ("selfmod.capitals.thresholdDuration" <= 120000)`),
			...
			new TableCheck({
				name: this.generateCheckName(/* sql */`("selfmod.newlines.thresholdDuration" >= 0) AND ("selfmod.newlines.thresholdDuration" <= 120000)`),
			...
			new TableCheck({
				name: this.generateCheckName(/* sql */`("selfmod.invites.thresholdDuration" >= 0) AND ("selfmod.invites.thresholdDuration" <= 120000)`),
			...
			new TableCheck({
				name: this.generateCheckName(/* sql */`("selfmod.filter.thresholdDuration" >= 0) AND ("selfmod.filter.thresholdDuration" <= 120000)`),
			...
			new TableCheck({
				name: this.generateCheckName(/* sql */`("selfmod.reactions.thresholdMaximum" >= 0) AND ("selfmod.reactions.thresholdMaximum" <= 20)`),
			...
			new TableCheck({
				name: this.generateCheckName(/* sql */`("selfmod.reactions.thresholdDuration" >= 0) AND ("selfmod.reactions.thresholdDuration" <= 120000)`),
			...
			new TableCheck({
				name: this.generateCheckName(/* sql */`("selfmod.messages.thresholdDuration" >= 0) AND ("selfmod.messages.thresholdDuration" <= 120000)`),
