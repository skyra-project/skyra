...
export class SettingsMenu {
	...
	public get pointerIsFolder() {
		return this.schema instanceof Schema;
	}

	public get changedCurrentPieceValue() {
	...
	public async onReaction(reaction, user) {
	...
	public _removeReactionFromUser(reaction, user) {
		// @ts-ignore
	...
	public async tryUpdate(value, options) {
