...
export const ChannelsRoles = T<string>('settings:channelsRoles');
...
export const MessagesWarnings = T<string>('settings:messagesWarnings');
...
export const SelfmodRaid = T<string>('settings:selfmodRaid');
export const SelfmodRaidThreshold = T<string>('settings:selfmodRaidThreshold');
