...
export const ConfGuarded = T<(params: { name: string }) => string>('commandConfGuarded');
export const ConfUpdated = T<(params: { key: string; response: string }) => string>('commandConfUpdated');
export const ConfKeyNotArray = T<string>('commandConfKeyNotArray');
export const ConfGetNoExt = T<(params: { key: string }) => string>('commandConfGetNoExt');
export const ConfGet = T<(params: { key: string; value: string }) => string>('commandConfGet');
export const ConfReset = T<(params: { key: string; value: string }) => string>('commandConfReset');
export const ConfNochange = T<(params: { key: string }) => string>('commandConfNochange');
export const ConfServerDescription = T<string>('commandConfServerDescription');
export const ConfServer = T<(params: { key: string; list: string }) => string>('commandConfServer');
export const ConfUserDescription = T<string>('commandConfUserDescription');
export const ConfUser = T<(params: { key: string; list: string }) => string>('commandConfUser');
...
export const RolesetCreated = T<(params: { name: string; roles: string }) => string>('commandRolesetCreated');
export const RolesetAdded = T<(params: { name: string; roles: string }) => string>('commandRolesetAdded');
export const RolesetInvalidName = T<(params: { name: string }) => string>('commandRolesetInvalidName');
export const RolesetRemoved = T<(params: { name: string; roles: string }) => string>('commandRolesetRemoved');
...
export const RolesetResetNotExists = T<(params: { name: string }) => string>('commandRolesetResetNotExists');
export const RolesetResetGroup = T<(params: { name: string }) => string>('commandRolesetResetGroup');
export const RolesetUpdated = T<(params: { name: string }) => string>('commandRolesetUpdated');
...
export const ConfMenuRenderAtFolder = T<(params: { path: string }) => string>('commandConfMenuRenderAtFolder');
export const ConfMenuRenderAtPiece = T<(params: { path: string }) => string>('commandConfMenuRenderAtPiece');
...
export const ConfMenuRenderCvalue = T<(params: { value: string }) => string>('commandConfMenuRenderCvalue');
