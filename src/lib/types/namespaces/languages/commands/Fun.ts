...
export const ChoiceDuplicates = T<(params: { words: string }) => string>('commandChoiceDuplicates');
...
export const ChoiceOutput = T<(params: { user: string; word: string }) => string>('commandChoiceOutput');
...
export const DiceOutput = T<(params: { result: number }) => string>('commandDiceOutput');
...
export const EightballOutput = T<(params: { author: string; question: string; response: string }) => string>('command8ballOutput');
...
export const EscaperopeOutput = T<(params: { user: User }) => string>('commandEscaperopeOutput');
...
export const MarkovTimer = T<(params: { timer: string }) => string>('commandMarkovTimer');
...
export const RateOutput = T<(params: { author: string; userToRate: string; rate: number; emoji: string }) => string>('commandRateOutput');
...
export const XkcdComics = T<(params: { amount: number }) => string>('commandXkcdComics');
