...
export const GuildInfoMembers = FT<{ count: string; owner: User }, string[]>('commands/management:guildInfoMembers');
...
export const SetModLogsSet = FT<{ channel: string }, string>('commands/management:setModLogsSet');
