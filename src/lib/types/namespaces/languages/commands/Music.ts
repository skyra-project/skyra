...
export const AddPlaylistSongsPlural = FT<{ count: number }, string>('commands/music:addPlaylistSongsPlural');
...
export const ClearSuccessPlural = FT<{ count: number }, string>('commands/music:clearSuccessPlural');
