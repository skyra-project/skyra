...
export const MarryTakenPlural = FT<{ count: number }, string>('commands/social:marryTakenPlural');
...
export const MarriedExtended = T<string>('commands/social:marriedExtended');
...
export const ReputationPlural = FT<{ count: number }, string>('commands/social:reputationPlural');
...
export const SocialAddPlural = FT<{ user: string; amount: number; count: number }, string>('commands/social:socialAddPlural');
...
export const SocialRemovePlural = FT<{ user: string; amount: number; count: number }, string>('commands/social:socialRemovePlural');
