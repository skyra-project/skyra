...
export const DisableExtended = T<string>('commands/system:disableExtended');
...
export const EnableExtended = T<string>('commands/system:enableExtended');
...
export const LoadExtended = T<string>('commands/system:loadExtended');
...
export const ReloadExtended = T<string>('commands/system:reloadExtended');
...
export const UnloadExtended = T<string>('commands/system:unloadExtended');
