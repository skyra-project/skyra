...
export const CoinFlipInvalidCoinName = FT<{ parameter: string }, string>('commands/game:coinFlipInvalidCoinName');
export const CoinFlipHeadNames = T<string[]>('commands/game:coinFlipHeadNames');
export const CoinFlipTailNames = T<string[]>('commands/game:coinFlipTailNames');
