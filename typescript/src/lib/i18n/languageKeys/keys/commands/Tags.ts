...
export const TagCannotAlias = FT<{ tag: string }, string>('commands/tags:cannotAlias');
export const TagAlias = FT<{ output: string; input: string }, string>('commands/tags:alias');
